...
import '../../components/json/report_json.dart';
import '../../config/config.dart';
import '../../routes/route_generator.dart';
import '../../routes/route_name.dart';
import '../../utils/aws_service/file_data_model.dart';

class TenantReportController extends GetxController {
  ...
  Future<void> onInit() async {
    ...
    devPrint(pageName);
    dialogBoxData.value = ReportJson.designationFormFields(pageName.value);
  ...
  @override
  void dispose() {
    Get.delete<TenantReportController>();
    super.dispose();
  }
  ...
  List fieldOrder = [
    ...
    {
      'text': "Common Consent",
      'field': 'commonconsentname',
    },
    {
      'text': "Individual Consent",
      'field': 'individualconsentname',
    },
    {
      'text': "Individual Agreement",
      'field': 'individualagreementname',
    },
    {
      'text': "Hutment Support",
      'field': 'hutmentsupportname',
    },
