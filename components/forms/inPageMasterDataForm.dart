...
import 'package:prestige_prenew_frontend/controller/inPageMasterDataFormController.dart';
...
class InPageMasterDataForm extends StatefulWidget {
  const InPageMasterDataForm({
    super.key,
    this.isMasterForm = false,
    this.title = "Add",
    this.btnName = StringConst.kAddBtnTxt,
    this.saveAndAddBtnName = StringConst.kSaveAndAddBtnTxt,
    required this.dialogBoxData,
  ...
  final Map<String, dynamic> dialogBoxData;
  final String pagename;
  final Function()? onDataAdd;

  @override
  State<InPageMasterDataForm> createState() => _InPageMasterDataFormState();
}

class _InPageMasterDataFormState extends State<InPageMasterDataForm> {
  InPageMasterDataFormController controller = Get.put(InPageMasterDataFormController());

  @override
  initState() {
    controller.dialogBoxData.value = widget.dialogBoxData;
    controller.pageName.value = widget.pagename;
    controller.onInitl();
    super.initState();
  }
                ...
                Container(
                  ...
                  child: Center(
                    child: Row(
                      children: [
                        TextWidget(
                          text: '${widget.title} ${controller.dialogBoxData['formname']}',
                          ...
                          ...List.generate(controller.dialogBoxData["formfields"][index]["formFields"].length, (i) {
                            ...
                            switch (res["type"]) {
                              case HtmlControls.kInputTextArea:
                                return Obx(() {
                                  var textController = TextEditingController(
                                      text: (widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]].toString().isEmpty ||
                                              (widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]] == null
                                          ? ""
                                          : (widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]].toString());
                                      ...
                                      child: CustomTextFormField(
                                        ...
                                        inputFormatters: [
                                          if (res['field'] == 'email' || res['field'] == 'person_email' || res['field'] == 'personemail')
                                            ...
                                            FilteringTextInputFormatter.deny(RegExp("[+,;:!#\$%^&*=_/<>?~]"))
                                          else if ((getCurrentPageName() == 'subapprovalcategory' || getCurrentPageName() == 'governmentauthority' || getCurrentPageName() == 'approvalcategory') && res['field'] == 'name')
                                            FilteringTextInputFormatter.deny(RegExp(""))
                                ...
                                return Obx(() {
                                  ...
                                  return constrainedBoxWithPadding(
                                      ...
                                      child: CustomCheckBox(
                                        focusNode: controller.focusNodes[focusOrderCode],
                                        label: res["text"],
                                        value: (widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]] == 1,
                                        onChanged: (v) async {
                                          await controller.handleFormData(
                                            key: res["field"],
                                            value: v,
                                ...
                                return Obx(() {
                                  return constrainedBoxWithPadding(
                                    ...
                                    child: MultiDropDownSearchCustom(
                                      selectedItems: List<Map<String, dynamic>>.from(((widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]]) ?? []),
                                      field: res["field"],
                                      ...
                                      initValue: ((widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]] ?? "").toString().isNotNullOrEmpty
                                          ? null
                                          : (widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]]?.last,
                                      isRequire: res["required"],
                                      textFieldLabel: res["text"],
                              ...
                              case HtmlControls.kAvatarPicker:
                                return Obx(
                                  () {
                                    var field = (widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]] ?? {};
                              ...
                              case HtmlControls.kDatePicker:
                                return Obx(
                                  () {
                                    var textController = TextEditingController(
                                        text: ((widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]] ?? "").toString().isNullOrEmpty
                                            ? ""
                                            : DateFormat("dd-MM-yyyy").format(DateTime.parse((widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]]).toLocal()).toString());
                                    if (controller.cursorPos <= textController.text.length) {
                                      textController.selection = TextSelection.collapsed(offset: controller.cursorPos);
                                    } else {
                                      textController.selection = TextSelection.collapsed(offset: textController.text.length);
                                    ...
                                    return constrainedBoxWithPadding(
                                      ...
                                      child: CustomTextFormField(
                                        ...
                                        onTap: () => showCustomDatePicker(
                                          initialDate: ((widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]] ?? "").toString().isNotNullOrEmpty
                                              ? DateTime.parse((widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]]).toLocal()
                                              : DateTime.now(),
                              ...
                              case HtmlControls.kDropDown:
                                return Obx(() {
                                  ...
                                  if (res.containsKey("isselfrefernce") &&
                                      res["isselfrefernce"] &&
                                      (widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["isselfreferncefield"]].toString().isNotEmpty) {
                                    list = controller.setDefaultData.masterData[masterdatakey].map((e) {
                                      if ((widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["isselfreferncefield"]] != e["label"]) {
                                        return e;
                                      }
                                    }).toList();
                                    list.remove(null);
                                  ...
                                  return constrainedBoxWithPadding(
                                      ...
                                      child: DropDownSearchCustom(
                                        ...
                                        clickOnAddBtn: () async {
                                          ...
                                          // IISMethods().hasAddRight(alias: controller.pageName.value)
                                          //     ? () async {
                                          // controller.getMasterData(pageNo: pageNo, fieldObj: fieldObj);
                                          // CustomDialogs().customFilterDialogs(context: context, widget: const MasterForm(isMasterForm: true,));
                                          // Get.dialog(
                                        ...
                                        isSearchable: res["searchable"],
                                        initValue: (list ?? []).where((element) => element["value"] == (widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]]).toList().isNotEmpty
                                            ? list.where((element) => element["value"] == (widget.isMasterForm ? controller.setDefaultData.masterFormData : controller.setDefaultData.formData)[res["field"]]).toList()?.first ?? {}
                                            : null,
                                        onChanged: (v) async {
                                          await controller.handleFormData(
                                            key: res["field"],
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                              ...
                              child: CustomButton(
                                onTap: (!controller.addButtonLoading.value && controller.uploadDocCount.value == 0)
                                    ? () async {
                                        ...
                                        if (await controller.handleAddButtonClick(saveAndAdd: false) && widget.onDataAdd != null) {
                                          await widget.onDataAdd!();
                                        }
                          ...
                          if (widget.btnName.toUpperCase() == StringConst.kAddBtnTxt) ...[
                            Obx(() {
                              return Expanded(
                                child: CustomButton(
                                  ...
                                  fontColor: ColorTheme.kWhite,
                                  borderRadius: 4,
                                  title: widget.saveAndAddBtnName,
                                ),
                              );
                            }),
                            const SizedBox(width: 10),
